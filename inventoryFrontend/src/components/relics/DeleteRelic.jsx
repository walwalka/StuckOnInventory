...
const DeleteRelic = () => {
  ...
  const handleDeleteRelic = () => {
    ...
    api
      ...
      .then(() => {
        setLoading(false);
        enqueueSnackbar('Relic deleted', { variant: 'success' });
        navigate('/relics');
      })
      .catch((error) => {
        setLoading(false);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-50">
      ...
      <div className='flex flex-col items-center border-2 usd-border-copper bg-white rounded-xl w-[420px] p-8 mx-auto shadow-2xl relative'>
        <h1 className='text-2xl mb-3 usd-text-green'>Delete Relic</h1>
        <p className='text-center text-sm usd-muted mb-6'>Are you sure you want to delete this relic? This action cannot be undone.</p>
