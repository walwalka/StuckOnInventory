      ...
      <div className="overflow-x-auto rounded-lg border-2 usd-border-green shadow-sm">
        <table className='w-full border-collapse'>
          <thead className='bg-gray-100 dark:bg-[#3c3c3c]'>
            <tr>
              <th className='border-b-2 usd-border-green px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-stone-200'>#</th>
              ...
              <th className='border-b-2 usd-border-green px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-stone-200'>Face Value (USD)</th>
              ...
              <tr key={type.id} className='hover:bg-gray-50 dark:hover:bg-[#4a4a4a] transition-colors'>
                ...
                <td className='px-4 py-3'>
                  <div className='flex justify-center gap-x-3'>
                    <button onClick={() => handleDetailsClick(type)} className="hover:scale-110 transition-transform">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 backdrop-blur-sm z-50 p-4">
          <div className='flex flex-col border-2 usd-border-green bg-white dark:bg-[#2c2c2c] rounded-xl max-w-md w-full p-6 shadow-2xl'>
            <div className="flex items-center justify-between mb-4">
              <h1 className='text-2xl usd-text-green font-semibold'>Coin Type Details</h1>
              <button
                onClick={closeModal}
            ...
            <div className='my-2'>
              ...
              <span className='text-gray-900 dark:text-gray-100'>${Number(selectedType.face_value).toFixed(2)}</span>
            </div>
