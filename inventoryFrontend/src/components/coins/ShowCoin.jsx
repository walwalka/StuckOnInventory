      ...
      <div className='flex flex-col border-2 usd-border-green bg-white dark:bg-[#2c2c2c] rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 mx-auto shadow-2xl relative my-8'>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className='py-2'>
            ...
            <div className='text-gray-700 dark:text-gray-100'>{coin.id}</div>
          </div>
          <div className='py-2'>
            <div className='text-sm font-semibold usd-text-green mb-1'>Type</div>
            <div className='text-gray-700 dark:text-gray-100'>{coin.type}</div>
          </div>
          <div className='py-2'>
            <div className='text-sm font-semibold usd-text-green mb-1'>Mint Location</div>
            <div className='text-gray-700 dark:text-gray-100'>{coin.mintlocation}</div>
          </div>
          <div className='py-2'>
            <div className='text-sm font-semibold usd-text-green mb-1'>Mint Year</div>
            <div className='text-gray-700 dark:text-gray-100'>{moment.utc(coin.mintyear).format("YYYY")}</div>
          </div>
          <div className='py-2'>
            <div className='text-sm font-semibold usd-text-green mb-1'>Circulated</div>
            <div className='text-gray-700 dark:text-gray-100'>{coin.circulation}</div>
          </div>
          <div className='py-2'>
        ...
        <div className="grid grid-cols-2 gap-4 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className='py-2'>
            ...
            <div className='text-sm text-gray-600 dark:text-gray-300'>{moment(coin.createdAt).format("MMM D, YYYY h:mm A")}</div>
          </div>
          <div className='py-2'>
            <div className='text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1'>Last Updated</div>
            <div className='text-sm text-gray-600 dark:text-gray-300'>{moment(coin.updatedAt).format("MMM D, YYYY h:mm A")}</div>
          </div>
        </div>
