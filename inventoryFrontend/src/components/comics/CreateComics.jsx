...
const CreateComics = () => {
  ...
  useEffect(() => {
    api
      ...
      .catch((error) => {
        console.log('Error fetching comic publishers:', error);
      });
  }, []);
  ...
  const handleSaveComic = async () => {
    ...
    try {
      ...
      if (selectedFiles.length > 0) {
        ...
        await axios.post(`/api/comics/upload/${newComicId}`, formData, {
          headers: {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-50 p-4 overflow-y-auto">
      <div className='flex flex-col border-2 usd-border-green bg-white dark:bg-[#2c2c2c] rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 mx-auto shadow-2xl relative my-8'>
        ...
        {loading ? <Spinner /> : ''}
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Title *</label>
            <input
              type='text'
              value={title}
          ...
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Publisher *</label>
            <select
              value={publisher}
          ...
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Issue Number *</label>
            <input
              type='text'
              value={issuenumber}
          ...
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Publication Year *</label>
            <input
              type='text'
          ...
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Variant</label>
            <input
              type='text'
              value={variant}
          ...
          <div className='my-4'>
            <label className='text-xl mr-4 usd-muted'>Comic Images (Optional, up to 3)</label>
          ...
          <button className='p-2 usd-btn-green m-8 rounded hover:opacity-90' onClick={handleSaveComic}>
            Save
          </button>
      </div>
    </div>
